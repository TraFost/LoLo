    ...
    <>
      <div className={cn('relative', expanded ? 'invisible' : 'visible', className)}>
        <motion.div
          ...
          className={cn(
            'overflow-hidden border-2 bg-card text-card-foreground shadow-lg rounded-xl',
            containerClassName,
          )}
        >
          <motion.div
                ...
                >
                  ...
                  {title && (
                    <motion.h3
                      ...
                      className={cn(
                        'mt-4 max-w-xs text-center text-sm font-medium text-white/80 md:max-w-md md:text-base',
                        titleClassName,
                      )}
                    >
                      {title}
